...
if(is_uploaded_file($plik_tmp)) {
     move_uploaded_file($plik_tmp, "C:/www/game/game/icon/$plik_nazwa");
...
//echo "Connected successfully";
   ...
   // $a = move_uploaded_file($plik_tmp, "upload/$plik_nazwa");
	  $a = move_uploaded_file($plik_tmp, "C:/www/game/game/source/$plik_nazwa");
//    echo $a;
//    echo "Plik: <strong>$plik_nazwa</strong> o rozmiarze
//    <strong>$plik_rozmiar bajtów</strong> został przesłany na serwer!";
    $sql = "INSERT INTO GameCenter.Game (name,descryption,category,ico_path,file_path,rate) VALUES  ('". $name. "','". $desc. "','". $category."','".$picName."','".$plik_nazwa."','0')";
    echo $sql;
    ...
    <div class="timeline">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="form_main">
                        <h4 class="heading"><strong>Dodaj Grę </strong> <span></span></h4>
                        <div class="form">
